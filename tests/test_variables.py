...
class TestVariables:
    ...
    #     assert m == (n==2) # tricky because n == 2 is a terminal
    #     assert m == True
    #     assert n == 2

    #     assert m.DBC_check() == TenaryReturn.VALID # should raise something? not implemented? .. But should not be hard. Need to allow additional values in a terminal .. but they must be bool?
    ...
    def test_multi(self):
        ...
        assert m.DBC_check() == TenaryReturn.UNRESOLVED # should raise something? not implemented? .. But should not be hard. Need to allow additional values in a terminal .. but they must be bool?
        ...
        assert m.DBC_check(raise_errors=False) == TenaryReturn.VALID # should raise something? not implemented? .. But should not be hard. Need to allow additional values in a terminal .. but they must be bool?
